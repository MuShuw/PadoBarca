...
public class PartieBarca {
	...
	public static Config createConfig(){
		...
		while ( classique == 0 ){
			...
			// On va vérifier si la réponse est oui ou non.
			if ( entree == "O") { 
				config.setPlateauDim(PartieBarca.creatDim());
				classique = 1;
			}
			else if ( entree == "N") classique = 1;
		}
	...
	private static Coordonnees creatDim() {
		Scanner scan = new Scanner(System.in);	
		String entree;
	...
	public static void main(String[] args){
		...
		config = PartieBarca.createConfig();
		...
		boolean plop = game.plateau.getCases()[0][2].contientPion();
