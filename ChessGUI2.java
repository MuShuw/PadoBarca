...
public class ChessGUI2 {
	...
	public final void initializeGui() {
        ...
        // set up the main GUI
        gui.setBorder(new EmptyBorder(50, 5, 5, 5));
...
//        chessBoard = new JPanel(new GridLayout(0, 9)) {
        ...
        for (int ii = 0; ii < 10; ii++) {
            ...
            for (int jj = 0; jj < 10; jj++) {
                switch (jj) {
                    case 0:
                        row.add(new JLabel("" + (11-(ii + 1)), SwingConstants.CENTER), new Float(1));
                    default:
    ...
    private final void createImages() {
        try {
            File url = new File("/home/sdv/m1bi/emouhou/Téléchargements/memI0.png");
